...
# load .env only if in development
...
MIDDLEWARE = [
    ...
    "users.middleware.BlockAdminMiddleware",
]
...
ACCOUNT_EMAIL_VERIFICATION = "none"  # Disable email verification [3]
ACCOUNT_EMAIL_REQUIRED = True
SOCIALACCOUNT_EMAIL_VERIFICATION = "none"
SOCIALACCOUNT_LOGIN_ON_GET = True  # Skip intermediate page [2]
SOCIALACCOUNT_STORE_TOKENS = True
ACCOUNT_USER_MODEL_USERNAME_FIELD = None
AUTH_USER_MODEL = "users.User"

# Disable local account forms
ACCOUNT_LOGIN_METHODS = {"email"}
ACCOUNT_USERNAME_REQUIRED = False
ACCOUNT_FORMS = {"signup": "your_app.forms.DisabledSignupForm"}
...
# Django told to use s3 for media
DEFAULT_FILE_STORAGE = "storages.backends.s3boto3.S3Boto3Storage"

# Our media settings
MEDIA_URL = "https://cs-3240-board-game-bucket.s3.amazonaws.com/"
